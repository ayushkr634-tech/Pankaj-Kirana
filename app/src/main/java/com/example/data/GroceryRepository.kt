...
class GroceryRepository(private val dao: GroceryDao) {
    ...
    suspend fun seedDatabaseIfNeeded() {
        ...
        if (currentAddresses.isEmpty()) {
            dao.insertAddress(AddressEntity(title = "Home", addressLine = "H No. 42, Green Park Colony, Ranchi, Jharkhand - 834001"))
            dao.insertAddress(AddressEntity(title = "Office", addressLine = "Pankaj Kirana Store, Sector 2, Market Yard, Ranchi, Jharkhand - 834001"))
        }
    }
}
